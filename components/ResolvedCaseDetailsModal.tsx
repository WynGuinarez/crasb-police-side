          ...
          <div className="glass-card bg-status-resolved-50/80 backdrop-blur-lg border-2 border-status-resolved-300/50">
            <div className="flex items-start">
              ...
              <div className="flex-1">
                <h3 className="text-lg font-bold text-status-resolved-900 mb-2">
                  Resolution Summary
                </h3>
                ...
                <div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-600 mt-0.5">{case_.city}, {case_.barangay}</p>
                    </div>
                  </div>
                </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-status-resolved-700 font-medium mt-1">
                    Resolution Time: {case_.resolutionTime}
                  </p>
                </div>
              </div>
            </div>
